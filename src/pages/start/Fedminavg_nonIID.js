...
import Mincostpa from "../../components/Mincostpa";
import Mincost_re from "../../components/Mincost_re";
...
export default function Board() {
  ...
  const [parametervalue, setparameter] = useState([]);
...
const handlenadata = (e) => {
  console.log('another',e)
  setparanameter(e);
  };
  const getStepContent =(step,handledata) => {
    switch (step) {
      case 0:
        return <Dataupload handledata={handledata}/>;
      case 1:
        return <Mincostpa checkedvalue={checkedvalue} handlealldata={handlealldata} handlenadata={handlenadata}/>;
      case 2:
        return <Mincost_re checkedvalue={checkedvalue} parametervalue={parametervalue} paramnavalue={paramnavalue}/>;
      case 3:
      ...
      <GridContainer>
        ...
        <Card>
            <CardHeader color="info">
              <h4 className={classes.cardTitleWhite}>异构Non-IID数据设置</h4>
              <p className={classes.cardCategoryWhite}>MinCost</p>
            </CardHeader>
            <CardBody>
              <GridContainer>
                <GridItem xs={1} md={1}>
