...
const handlenadata = (e) => {
  ...
  const getStepContent =(step,handledata) => {
    switch (step) {
      ...
      case 1:
        return <Parameter checkedvalue={checkedvalue} handlealldata={handlealldata} handlenadata={handlenadata}/>;
      case 2:
        return <Review checkedvalue={checkedvalue} parametervalue={parametervalue} paramnavalue={paramnavalue}/>;
      case 3:
      ...
      <GridContainer>
        ...
        <Card>
            <CardHeader color="info">
              <h4 className={classes.cardTitleWhite}>异构IID数据设置</h4>
              <p className={classes.cardCategoryWhite}>BLAP</p>
            </CardHeader>
            <CardBody>
              <GridContainer>
                <GridItem xs={1} md={1}>
