...
import Fedpara from "../../components/Fedpara";
import Fedreview from "../../components/Fedreview";
...
export default function FedAvg() {
  ...
  const getStepContent =(step) => {
    switch (step) {
      ...
      case 1:
        return <Fedpara cRef={fedpara}/>;
      case 2:
        return <Fedreview checkedvalue={checkedvalue} paramnavalue={paramnavalue}/>;
      case 3:
      ...
      <GridContainer>
        ...
        <Card>
            <CardHeader color="info">
              <h4 className={classes.cardTitleWhite}>FedAvg算法-IID数据</h4>
            </CardHeader>
            <CardBody>
              <GridContainer>
                <GridItem xs={1} md={1}>
